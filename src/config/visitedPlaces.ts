...
export const visitedPlaces: VisitedPlace[] = [
  ...
  { name: "台北",          coords: [121.50,  25.03] },
  { name: "首尔",          coords: [126.97,  37.56] },
  { name: "东京",          coords: [139.69,  35.68] },
  { name: "曼谷",          coords: [100.50,  13.75] },
  { name: "新加坡",        coords: [103.82,   1.35] },
  { name: "巴厘岛",        coords: [115.18,  -8.40] },
  { name: "叶卡捷琳堡",    coords: [ 60.61,  56.84] },
  { name: "New York",      coords: [-74.00,  40.71] },
  { name: "Albany",        coords: [-73.75,  42.65] },
  { name: "LA",            coords: [-118.24, 34.05] },
